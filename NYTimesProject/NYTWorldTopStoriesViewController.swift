//
//  NYTWorldTopStoriesViewController.swift
//  NYTimesProject
//
...
class NYTWorldTopStoriesViewController: UIViewController {
    ...
    let worldCellIdentifier = "worldStoryCollectionViewCell"
    ...
    func configure() {
        ...
        storyCollectionView.register(StoryCollectionViewCell.self, forCellWithReuseIdentifier: worldCellIdentifier)
        storyCollectionView.delegate = self
        storyCollectionView.dataSource = self
    }
}

extension NYTWorldTopStoriesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: worldCellIdentifier, for: indexPath) as? StoryCollectionViewCell {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let url = URL(string: stories[indexPath.row].shortURL!) {
